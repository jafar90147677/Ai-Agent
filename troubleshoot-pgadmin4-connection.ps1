# Troubleshoot pgAdmin4 Connection Issues
Write-Host "Troubleshooting pgAdmin4 Connection..." -ForegroundColor Cyan
...
Write-Host "============================" -ForegroundColor Yellow
docker exec github-tracker-postgres psql -U user -d github_tracker_db -c "SELECT 'Connection successful' as status, current_user, current_database();"

# Check if data exists
Write-Host "`n3. Data Verification:" -ForegroundColor Yellow
Write-Host "=====================" -ForegroundColor Yellow
...
Write-Host "`n4. Port Accessibility:" -ForegroundColor Yellow
Write-Host "======================" -ForegroundColor Yellow
Write-Host "Testing if port 5432 is accessible from host..." -ForegroundColor White
try {
...
# Show exact connection details
Write-Host "`n5. EXACT Connection Details for pgAdmin4:" -ForegroundColor Yellow
Write-Host "=========================================" -ForegroundColor Yellow
...
# Common mistakes
Write-Host "`n6. Common Mistakes to Avoid:" -ForegroundColor Red
...
Write-Host "❌ Port: '5433' (should be '5432')" -ForegroundColor Red
...
# Step-by-step fix
Write-Host "`n7. Step-by-Step Fix:" -ForegroundColor Yellow
Write-Host "====================" -ForegroundColor Yellow
...
Write-Host "`n8. Test Connection from Command Line:" -ForegroundColor Yellow
Write-Host "=====================================" -ForegroundColor Yellow
...
# Show sample data
Write-Host "`n9. Sample Data Available:" -ForegroundColor Yellow
Write-Host "=========================" -ForegroundColor Yellow
...
Write-Host "`n10. Troubleshooting Steps:" -ForegroundColor Yellow
Write-Host "=========================" -ForegroundColor Yellow
